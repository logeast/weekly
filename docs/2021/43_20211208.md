...
### 2. 一篇介绍浏览器 [EyeDropper API](https://developer.mozilla.org/en-US/docs/Web/API/EyeDropper) 的[文章](https://polypane.app/blog/the-eye-dropper-api-pick-colors-from-anywhere-on-your-screen)

![image](../../images/2021/43_15.png)

### 3. [失真文字效果](https://creativecloud.adobe.com/zh-Hans/discover/article/free-distortion-effects-for-photoshop?trackingid=CD922JHD&mv=email)教程

PhotoShop 提供了免费的失真效果，玩家下载这些自定义效果来创造自己的作品。
...
### 5. [CSS 投影生成器](https://www.joshwcomeau.com/shadow-palette/?utm_source=CSS-Weekly&utm_campaign=Issue-482&utm_medium=email)

一款可视化生成 CSS 投影的网页工具。
![image](../../images/2021/43_16.png)
...
### 3. [Elementary Grid](https://teetow.github.io/elementary_grid)

使用 Elementary Audio 和 React 制作的音栅合成器。
![image](../../images/2021/43_13.png)

### 4. [tldraw](https://www.tldraw.com/)

一款小巧的在线绘图工具。
![image](../../images/2021/43_14.png)
